...
After planning:
- Use the `tdd-workflow` skill to implement with test-driven development (auto-activates on new features, bug fixes, and refactors)
- Use `/build-fix` if build errors occur
- Use `/code-review` to review local changes, or `/review-pr` for GitHub PR reviews
